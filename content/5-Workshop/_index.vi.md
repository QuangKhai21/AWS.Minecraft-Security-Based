...
![Sơ đồ Architecture](/images/5-Workshop/5.0/Architecture.png)

#### Chi phí dự án

Các hình dưới đây là ước tính chi phí hàng tháng cho lab này (AWS Pricing Calculator):

![Tổng quan chi phí](/images/5-Workshop/5.0/0.a.Bill.png)

![Chi tiết chi phí](/images/5-Workshop/5.0/0.b.Bill.png)
